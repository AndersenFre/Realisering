...
public class AdminAndraAdminStatus extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ändra Adminstatus");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminAndraAdminStatus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new AdminAndraAdminStatus().setVisible(true);
            }
        });
    }
